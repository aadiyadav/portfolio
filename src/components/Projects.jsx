                ...
                <div className="border rounded-lg flex flex-col-reverse lg:flex-row justify-between items-center my-10 hover:shadow-proj transition">
                    <div className="p-4">
                        <div className="flex justify-between items-center">
                            ...
                            <button className="py-2 px-4 ml-2 border rounded-md hover:bg-white
                             hover:text-black transition duration-300 ease-in-out"
                              onClick={() => handleClick('https://github.com/aadiyadav/BakeHouse.git')}>
                               Github
                            </button>
                        </div>
                        <div className="my-2 text-sm font-nine">I developed a multi-page
                        ...
                        <div className="flex flex-wrap lg:flex-row gap-x-2 font-eight text-base">
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">HTML</span>
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">CSS</span>
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">Javascript</span>
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">React</span>
                        </div>
                    </div>
                    <div>
                        <img src={Bake} alt="YO"
                ...
                <div className="border rounded-lg flex flex-col-reverse lg:flex-row justify-between items-center my-10 hover:shadow-proj transition">
                    <div className="p-4">
                        <div className="flex justify-between items-center">
                            ...
                            <button className="py-2 px-4 lg:mr-4 ml-2 border rounded-md hover:bg-white
                             hover:text-black transition duration-300 ease-in-out"
                             onClick={() => handleClick("https://github.com/aadiyadav/PeaQuack-Frontend.git")}>
                                Github
                            </button>
                        </div>
                        <div className="my-2 text-sm font-nine">It is a single-page social media website 
                        ...
                        <div className="flex flex-wrap lg:flex-row gap-x-2 font-eight text-base">
                            ...
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">Javascript</span>
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">React</span>
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">MaterialUI</span>
                        </div>
                    </div>
                    <div>
                ...
                <div className="border rounded-lg flex flex-col-reverse lg:flex-row justify-between items-center my-10 hover:shadow-proj transition">
                    <div className="p-4">
                        <div className="flex justify-between items-center">
                            ...
                            <button className="py-2 px-4 lg:mr-5 ml-2 border rounded-md hover:bg-white
                             hover:text-black transition duration-300 ease-in-out"
                             onClick={() => handleClick("https://github.com/aadiyadav/fintech.git")}>
                                Github
                            </button>
                        </div>
                        <div className="my-2 text-sm font-nine">Developed a full-stack fintech platform 
                        ...
                        <div className="flex flex-wrap lg:flex-row gap-x-2 font-eight text-base">
                            <span href="" className="bg-white w-min my-1 rounded-xl px-2 text-back">React</span>
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">TailwindCSS</span>
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">Node.js</span>
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">Hasura</span>
                            <span href="" className="bg-white rounded-xl px-2 text-back w-min my-1">GraphQL</span>
                        </div>
                    </div>
